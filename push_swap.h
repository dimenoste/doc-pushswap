...
{
	void				(*handler_letter)(t_context *, t_states *mystates);
	void				(*handler_space)(t_context *, t_states *mystates);
	void				(*handler_digit)(t_context *, t_states *mystates);
	void				(*handler_dash)(t_context *, t_states *mystates);
	void				(*handler_other)(t_context *, t_states *mystates);
	void				(*handler_end)(t_context *, t_states *mystates);
}						t_state_interface;
...
void				stay_in_invalid(t_context *currState, t_states *mystates);
